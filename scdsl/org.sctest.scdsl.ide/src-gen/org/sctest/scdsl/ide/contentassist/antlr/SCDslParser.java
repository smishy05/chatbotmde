...
public class SCDslParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, SCDslGrammarAccess grammarAccess) {
			...
			builder.put(grammarAccess.getAssetRelAccess().getGroup_7(), "rule__AssetRel__Group_7__0");
			builder.put(grammarAccess.getAssetRelAccess().getGroup_8(), "rule__AssetRel__Group_8__0");
			...
			builder.put(grammarAccess.getAssetRelAccess().getParticipantAssignment_3(), "rule__AssetRel__ParticipantAssignment_3");
			builder.put(grammarAccess.getAssetRelAccess().getCreateAssignment_4_2(), "rule__AssetRel__CreateAssignment_4_2");
			builder.put(grammarAccess.getAssetRelAccess().getReadAssignment_5_2(), "rule__AssetRel__ReadAssignment_5_2");
			builder.put(grammarAccess.getAssetRelAccess().getUpdateAssignment_6_2(), "rule__AssetRel__UpdateAssignment_6_2");
			builder.put(grammarAccess.getAssetRelAccess().getDeleteAssignment_7_2(), "rule__AssetRel__DeleteAssignment_7_2");
			builder.put(grammarAccess.getAssetRelAccess().getAllAssignment_8_2(), "rule__AssetRel__AllAssignment_8_2");
		}
	}
