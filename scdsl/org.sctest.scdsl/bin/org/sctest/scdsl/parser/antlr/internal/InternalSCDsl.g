...
entryRulePostCondition returns [String current=null]:
	{ newCompositeNode(grammarAccess.getPostConditionRule()); }
	iv_rulePostCondition=rulePostCondition
	{ $current=$iv_rulePostCondition.current.getText(); }
	EOF;

// Rule PostCondition
rulePostCondition returns [AntlrDatatypeRuleToken current=new AntlrDatatypeRuleToken()]
@init {
	enterRule();
}
@after {
