...
public class InternalSCDslParser extends AbstractInternalAntlrParser {
    public static final String[] tokenNames = new String[] {
        "<invalid>", "<EOR>", "<DOWN>", "<UP>", "RULE_ID", "RULE_INT", "RULE_STRING", "RULE_ML_COMMENT", "RULE_SL_COMMENT", "RULE_WS", "RULE_ANY_OTHER", "'Contract'", "':'", "'Platform'", "'{'", "'Name'", "'List'", "'}'", "'Participant'", "'Creator'", "'T'", "'Asset'", "'Type'", "'Parameter'", "'Identifier'", "'Transaction'", "'Mostrar'", "'Condition'", "'PreCondition'", "'PostCondition'", "'Relationship'", "'From'", "'To'", "'Event'", "'Description'", "'TranRel'", "'Selected'", "'AssetRel'", "'Create'", "'Read'", "'Update'", "'Delete'", "'All'", "'IBM'", "'Azure'", "'Solidity'"
    };
    ...
    // InternalSCDsl.g:689:1: ruleCondition returns [EObject current=null] : ( ( rulePreCondition | rulePostCondition ) otherlv_2= '{' otherlv_3= 'Name' otherlv_4= ':' ( (lv_name_5_0= RULE_ID ) ) otherlv_6= 'Condition' otherlv_7= ':' ( (lv_condition_8_0= RULE_ID ) ) otherlv_9= '}' ) ;
    public final EObject ruleCondition() throws RecognitionException {
        ...
        try {
            // InternalSCDsl.g:695:2: ( ( ( rulePreCondition | rulePostCondition ) otherlv_2= '{' otherlv_3= 'Name' otherlv_4= ':' ( (lv_name_5_0= RULE_ID ) ) otherlv_6= 'Condition' otherlv_7= ':' ( (lv_condition_8_0= RULE_ID ) ) otherlv_9= '}' ) )
            // InternalSCDsl.g:696:2: ( ( rulePreCondition | rulePostCondition ) otherlv_2= '{' otherlv_3= 'Name' otherlv_4= ':' ( (lv_name_5_0= RULE_ID ) ) otherlv_6= 'Condition' otherlv_7= ':' ( (lv_condition_8_0= RULE_ID ) ) otherlv_9= '}' )
            {
            // InternalSCDsl.g:696:2: ( ( rulePreCondition | rulePostCondition ) otherlv_2= '{' otherlv_3= 'Name' otherlv_4= ':' ( (lv_name_5_0= RULE_ID ) ) otherlv_6= 'Condition' otherlv_7= ':' ( (lv_condition_8_0= RULE_ID ) ) otherlv_9= '}' )
            // InternalSCDsl.g:697:3: ( rulePreCondition | rulePostCondition ) otherlv_2= '{' otherlv_3= 'Name' otherlv_4= ':' ( (lv_name_5_0= RULE_ID ) ) otherlv_6= 'Condition' otherlv_7= ':' ( (lv_condition_8_0= RULE_ID ) ) otherlv_9= '}'
            {
            // InternalSCDsl.g:697:3: ( rulePreCondition | rulePostCondition )
            int alt10=2;
            ...
            switch (alt10) {
                case 1 :
                    // InternalSCDsl.g:698:4: rulePreCondition
                    {

                    				newCompositeNode(grammarAccess.getConditionAccess().getPreConditionParserRuleCall_0_0());
                    ...
                    break;
                case 2 :
                    // InternalSCDsl.g:706:4: rulePostCondition
                    {

                    				newCompositeNode(grammarAccess.getConditionAccess().getPostConditionParserRuleCall_0_1());
            ...
            otherlv_2=(Token)match(input,14,FOLLOW_9); 
            			...
            			newLeafNode(otherlv_2, grammarAccess.getConditionAccess().getLeftCurlyBracketKeyword_1());
            		
            otherlv_3=(Token)match(input,15,FOLLOW_3); 

            			newLeafNode(otherlv_3, grammarAccess.getConditionAccess().getNameKeyword_2());
            		
            otherlv_4=(Token)match(input,12,FOLLOW_4); 

            			newLeafNode(otherlv_4, grammarAccess.getConditionAccess().getColonKeyword_3());
            		
            // InternalSCDsl.g:726:3: ( (lv_name_5_0= RULE_ID ) )
            // InternalSCDsl.g:727:4: (lv_name_5_0= RULE_ID )
            {
            // InternalSCDsl.g:727:4: (lv_name_5_0= RULE_ID )
            // InternalSCDsl.g:728:5: lv_name_5_0= RULE_ID
            {
            lv_name_5_0=(Token)match(input,RULE_ID,FOLLOW_21); 

            					newLeafNode(lv_name_5_0, grammarAccess.getConditionAccess().getNameIDTerminalRuleCall_4_0());
            ...
            otherlv_6=(Token)match(input,27,FOLLOW_3); 
            			...
            			newLeafNode(otherlv_6, grammarAccess.getConditionAccess().getConditionKeyword_5());
            		
            otherlv_7=(Token)match(input,12,FOLLOW_4); 

            			newLeafNode(otherlv_7, grammarAccess.getConditionAccess().getColonKeyword_6());
            		
            // InternalSCDsl.g:752:3: ( (lv_condition_8_0= RULE_ID ) )
            // InternalSCDsl.g:753:4: (lv_condition_8_0= RULE_ID )
            {
            // InternalSCDsl.g:753:4: (lv_condition_8_0= RULE_ID )
            // InternalSCDsl.g:754:5: lv_condition_8_0= RULE_ID
            {
            lv_condition_8_0=(Token)match(input,RULE_ID,FOLLOW_18); 

            					newLeafNode(lv_condition_8_0, grammarAccess.getConditionAccess().getConditionIDTerminalRuleCall_7_0());
            ...
            otherlv_9=(Token)match(input,17,FOLLOW_2); 
            			...
            			newLeafNode(otherlv_9, grammarAccess.getConditionAccess().getRightCurlyBracketKeyword_8());
    ...
    // InternalSCDsl.g:778:1: entryRulePreCondition returns [String current=null] : iv_rulePreCondition= rulePreCondition EOF ;
    public final String entryRulePreCondition() throws RecognitionException {
        ...
        try {
            // InternalSCDsl.g:778:52: (iv_rulePreCondition= rulePreCondition EOF )
            // InternalSCDsl.g:779:2: iv_rulePreCondition= rulePreCondition EOF
            {
    ...
    // InternalSCDsl.g:785:1: rulePreCondition returns [AntlrDatatypeRuleToken current=new AntlrDatatypeRuleToken()] : kw= 'PreCondition' ;
    public final AntlrDatatypeRuleToken rulePreCondition() throws RecognitionException {
        ...
        try {
            // InternalSCDsl.g:791:2: (kw= 'PreCondition' )
            // InternalSCDsl.g:792:2: kw= 'PreCondition'
            {
            kw=(Token)match(input,28,FOLLOW_2); 

            		current.merge(kw);
            		newLeafNode(kw, grammarAccess.getPreConditionAccess().getPreConditionKeyword());
    ...
    // InternalSCDsl.g:800:1: entryRulePostCondition returns [String current=null] : iv_rulePostCondition= rulePostCondition EOF ;
    public final String entryRulePostCondition() throws RecognitionException {
        String current = null;

        AntlrDatatypeRuleToken iv_rulePostCondition = null;


        try {
            // InternalSCDsl.g:800:53: (iv_rulePostCondition= rulePostCondition EOF )
            // InternalSCDsl.g:801:2: iv_rulePostCondition= rulePostCondition EOF
            {
            ...
            state._fsp--;
             ...
             current =iv_rulePostCondition.getText(); 
            match(input,EOF,FOLLOW_2); 
    ...
    // InternalSCDsl.g:807:1: rulePostCondition returns [AntlrDatatypeRuleToken current=new AntlrDatatypeRuleToken()] : kw= 'PostCondition' ;
    public final AntlrDatatypeRuleToken rulePostCondition() throws RecognitionException {
        AntlrDatatypeRuleToken current = new AntlrDatatypeRuleToken();
        ...
        try {
            // InternalSCDsl.g:813:2: (kw= 'PostCondition' )
            // InternalSCDsl.g:814:2: kw= 'PostCondition'
            {
            kw=(Token)match(input,29,FOLLOW_2); 

            		current.merge(kw);
            		newLeafNode(kw, grammarAccess.getPostConditionAccess().getPostConditionKeyword());
    ...
    // InternalSCDsl.g:822:1: entryRuleRelationship returns [EObject current=null] : iv_ruleRelationship= ruleRelationship EOF ;
    public final EObject entryRuleRelationship() throws RecognitionException {
        ...
        try {
            // InternalSCDsl.g:822:53: (iv_ruleRelationship= ruleRelationship EOF )
            // InternalSCDsl.g:823:2: iv_ruleRelationship= ruleRelationship EOF
            {
    ...
    public final EObject ruleRelationship() throws RecognitionException {
        ...
        try {
            // InternalSCDsl.g:835:2: ( (otherlv_0= 'Relationship' (this_TranRel_1= ruleTranRel | this_AssetRel_2= ruleAssetRel ) otherlv_3= '{' otherlv_4= 'Name' otherlv_5= ':' ( (lv_name_6_0= RULE_ID ) ) otherlv_7= 'From' otherlv_8= ':' ( (otherlv_9= RULE_ID ) ) otherlv_10= 'To' otherlv_11= ':' ( (otherlv_12= RULE_ID ) ) ( (lv_event_13_0= ruleEvent ) )* otherlv_14= '}' ) )
            // InternalSCDsl.g:836:2: (otherlv_0= 'Relationship' (this_TranRel_1= ruleTranRel | this_AssetRel_2= ruleAssetRel ) otherlv_3= '{' otherlv_4= 'Name' otherlv_5= ':' ( (lv_name_6_0= RULE_ID ) ) otherlv_7= 'From' otherlv_8= ':' ( (otherlv_9= RULE_ID ) ) otherlv_10= 'To' otherlv_11= ':' ( (otherlv_12= RULE_ID ) ) ( (lv_event_13_0= ruleEvent ) )* otherlv_14= '}' )
            {
            // InternalSCDsl.g:836:2: (otherlv_0= 'Relationship' (this_TranRel_1= ruleTranRel | this_AssetRel_2= ruleAssetRel ) otherlv_3= '{' otherlv_4= 'Name' otherlv_5= ':' ( (lv_name_6_0= RULE_ID ) ) otherlv_7= 'From' otherlv_8= ':' ( (otherlv_9= RULE_ID ) ) otherlv_10= 'To' otherlv_11= ':' ( (otherlv_12= RULE_ID ) ) ( (lv_event_13_0= ruleEvent ) )* otherlv_14= '}' )
            // InternalSCDsl.g:837:3: otherlv_0= 'Relationship' (this_TranRel_1= ruleTranRel | this_AssetRel_2= ruleAssetRel ) otherlv_3= '{' otherlv_4= 'Name' otherlv_5= ':' ( (lv_name_6_0= RULE_ID ) ) otherlv_7= 'From' otherlv_8= ':' ( (otherlv_9= RULE_ID ) ) otherlv_10= 'To' otherlv_11= ':' ( (otherlv_12= RULE_ID ) ) ( (lv_event_13_0= ruleEvent ) )* otherlv_14= '}'
            {
            ...
            // InternalSCDsl.g:841:3: (this_TranRel_1= ruleTranRel | this_AssetRel_2= ruleAssetRel )
            int alt11=2;
            ...
            switch (alt11) {
                case 1 :
                    // InternalSCDsl.g:842:4: this_TranRel_1= ruleTranRel
                    {
                    ...
                    break;
                case 2 :
                    // InternalSCDsl.g:851:4: this_AssetRel_2= ruleAssetRel
                    {
            ...
            // InternalSCDsl.g:872:3: ( (lv_name_6_0= RULE_ID ) )
            // InternalSCDsl.g:873:4: (lv_name_6_0= RULE_ID )
            {
            // InternalSCDsl.g:873:4: (lv_name_6_0= RULE_ID )
            // InternalSCDsl.g:874:5: lv_name_6_0= RULE_ID
            {
            lv_name_6_0=(Token)match(input,RULE_ID,FOLLOW_23); 
            ...
            // InternalSCDsl.g:898:3: ( (otherlv_9= RULE_ID ) )
            // InternalSCDsl.g:899:4: (otherlv_9= RULE_ID )
            {
            // InternalSCDsl.g:899:4: (otherlv_9= RULE_ID )
            // InternalSCDsl.g:900:5: otherlv_9= RULE_ID
            {
            ...
            // InternalSCDsl.g:919:3: ( (otherlv_12= RULE_ID ) )
            // InternalSCDsl.g:920:4: (otherlv_12= RULE_ID )
            {
            // InternalSCDsl.g:920:4: (otherlv_12= RULE_ID )
            // InternalSCDsl.g:921:5: otherlv_12= RULE_ID
            {
            ...
            // InternalSCDsl.g:932:3: ( (lv_event_13_0= ruleEvent ) )*
            loop12:
            do {
                int alt12=2;
                ...
                switch (alt12) {
            	case 1 :
            	    // InternalSCDsl.g:933:4: (lv_event_13_0= ruleEvent )
            	    {
            	    // InternalSCDsl.g:933:4: (lv_event_13_0= ruleEvent )
            	    // InternalSCDsl.g:934:5: lv_event_13_0= ruleEvent
            	    {
    ...
    // InternalSCDsl.g:959:1: entryRuleEvent returns [EObject current=null] : iv_ruleEvent= ruleEvent EOF ;
    public final EObject entryRuleEvent() throws RecognitionException {
        ...
        try {
            // InternalSCDsl.g:959:46: (iv_ruleEvent= ruleEvent EOF )
            // InternalSCDsl.g:960:2: iv_ruleEvent= ruleEvent EOF
            {
    ...
    // InternalSCDsl.g:966:1: ruleEvent returns [EObject current=null] : (otherlv_0= 'Event' otherlv_1= '{' otherlv_2= 'Description' otherlv_3= ':' ( (lv_description_4_0= RULE_ID ) ) otherlv_5= 'Name' otherlv_6= ':' ( (lv_name_7_0= RULE_ID ) ) otherlv_8= '}' ) ;
    public final EObject ruleEvent() throws RecognitionException {
        ...
        try {
            // InternalSCDsl.g:972:2: ( (otherlv_0= 'Event' otherlv_1= '{' otherlv_2= 'Description' otherlv_3= ':' ( (lv_description_4_0= RULE_ID ) ) otherlv_5= 'Name' otherlv_6= ':' ( (lv_name_7_0= RULE_ID ) ) otherlv_8= '}' ) )
            // InternalSCDsl.g:973:2: (otherlv_0= 'Event' otherlv_1= '{' otherlv_2= 'Description' otherlv_3= ':' ( (lv_description_4_0= RULE_ID ) ) otherlv_5= 'Name' otherlv_6= ':' ( (lv_name_7_0= RULE_ID ) ) otherlv_8= '}' )
            {
            // InternalSCDsl.g:973:2: (otherlv_0= 'Event' otherlv_1= '{' otherlv_2= 'Description' otherlv_3= ':' ( (lv_description_4_0= RULE_ID ) ) otherlv_5= 'Name' otherlv_6= ':' ( (lv_name_7_0= RULE_ID ) ) otherlv_8= '}' )
            // InternalSCDsl.g:974:3: otherlv_0= 'Event' otherlv_1= '{' otherlv_2= 'Description' otherlv_3= ':' ( (lv_description_4_0= RULE_ID ) ) otherlv_5= 'Name' otherlv_6= ':' ( (lv_name_7_0= RULE_ID ) ) otherlv_8= '}'
            {
            ...
            // InternalSCDsl.g:990:3: ( (lv_description_4_0= RULE_ID ) )
            // InternalSCDsl.g:991:4: (lv_description_4_0= RULE_ID )
            {
            // InternalSCDsl.g:991:4: (lv_description_4_0= RULE_ID )
            // InternalSCDsl.g:992:5: lv_description_4_0= RULE_ID
            {
            ...
            // InternalSCDsl.g:1016:3: ( (lv_name_7_0= RULE_ID ) )
            // InternalSCDsl.g:1017:4: (lv_name_7_0= RULE_ID )
            {
            // InternalSCDsl.g:1017:4: (lv_name_7_0= RULE_ID )
            // InternalSCDsl.g:1018:5: lv_name_7_0= RULE_ID
            {
    ...
    // InternalSCDsl.g:1042:1: entryRuleTranRel returns [EObject current=null] : iv_ruleTranRel= ruleTranRel EOF ;
    public final EObject entryRuleTranRel() throws RecognitionException {
        ...
        try {
            // InternalSCDsl.g:1042:48: (iv_ruleTranRel= ruleTranRel EOF )
            // InternalSCDsl.g:1043:2: iv_ruleTranRel= ruleTranRel EOF
            {
    ...
    // InternalSCDsl.g:1049:1: ruleTranRel returns [EObject current=null] : ( () otherlv_1= 'TranRel' (otherlv_2= 'Selected' otherlv_3= ':' ( (lv_selected_4_0= 'T' ) ) )? ) ;
    public final EObject ruleTranRel() throws RecognitionException {
        ...
        try {
            // InternalSCDsl.g:1055:2: ( ( () otherlv_1= 'TranRel' (otherlv_2= 'Selected' otherlv_3= ':' ( (lv_selected_4_0= 'T' ) ) )? ) )
            // InternalSCDsl.g:1056:2: ( () otherlv_1= 'TranRel' (otherlv_2= 'Selected' otherlv_3= ':' ( (lv_selected_4_0= 'T' ) ) )? )
            {
            // InternalSCDsl.g:1056:2: ( () otherlv_1= 'TranRel' (otherlv_2= 'Selected' otherlv_3= ':' ( (lv_selected_4_0= 'T' ) ) )? )
            // InternalSCDsl.g:1057:3: () otherlv_1= 'TranRel' (otherlv_2= 'Selected' otherlv_3= ':' ( (lv_selected_4_0= 'T' ) ) )?
            {
            // InternalSCDsl.g:1057:3: ()
            // InternalSCDsl.g:1058:4: 
            {
            ...
            // InternalSCDsl.g:1068:3: (otherlv_2= 'Selected' otherlv_3= ':' ( (lv_selected_4_0= 'T' ) ) )?
            int alt13=2;
            ...
            switch (alt13) {
                case 1 :
                    // InternalSCDsl.g:1069:4: otherlv_2= 'Selected' otherlv_3= ':' ( (lv_selected_4_0= 'T' ) )
                    {
                    ...
                    // InternalSCDsl.g:1077:4: ( (lv_selected_4_0= 'T' ) )
                    // InternalSCDsl.g:1078:5: (lv_selected_4_0= 'T' )
                    {
                    // InternalSCDsl.g:1078:5: (lv_selected_4_0= 'T' )
                    // InternalSCDsl.g:1079:6: lv_selected_4_0= 'T'
                    {
    ...
    // InternalSCDsl.g:1096:1: entryRuleAssetRel returns [EObject current=null] : iv_ruleAssetRel= ruleAssetRel EOF ;
    public final EObject entryRuleAssetRel() throws RecognitionException {
        ...
        try {
            // InternalSCDsl.g:1096:49: (iv_ruleAssetRel= ruleAssetRel EOF )
            // InternalSCDsl.g:1097:2: iv_ruleAssetRel= ruleAssetRel EOF
            {
    ...
    // InternalSCDsl.g:1103:1: ruleAssetRel returns [EObject current=null] : (otherlv_0= 'AssetRel' otherlv_1= 'Participant' otherlv_2= ':' ( (lv_participant_3_0= RULE_ID ) ) (otherlv_4= 'Create' otherlv_5= ':' ( (lv_create_6_0= 'T' ) ) )? (otherlv_7= 'Read' otherlv_8= ':' ( (lv_read_9_0= 'T' ) ) )? (otherlv_10= 'Update' otherlv_11= ':' ( (lv_update_12_0= 'T' ) ) )? (otherlv_13= 'Delete' otherlv_14= ':' ( (lv_delete_15_0= 'T' ) ) )? (otherlv_16= 'All' otherlv_17= ':' ( (lv_all_18_0= 'T' ) ) )? ) ;
    public final EObject ruleAssetRel() throws RecognitionException {
        ...
        Token otherlv_4=null;
        Token otherlv_5=null;
        Token lv_create_6_0=null;
        Token otherlv_7=null;
        Token otherlv_8=null;
        Token lv_read_9_0=null;
        Token otherlv_10=null;
        Token otherlv_11=null;
        Token lv_update_12_0=null;
        Token otherlv_13=null;
        Token otherlv_14=null;
        Token lv_delete_15_0=null;
        Token otherlv_16=null;
        Token otherlv_17=null;
        Token lv_all_18_0=null;


        	enterRule();

        try {
            // InternalSCDsl.g:1109:2: ( (otherlv_0= 'AssetRel' otherlv_1= 'Participant' otherlv_2= ':' ( (lv_participant_3_0= RULE_ID ) ) (otherlv_4= 'Create' otherlv_5= ':' ( (lv_create_6_0= 'T' ) ) )? (otherlv_7= 'Read' otherlv_8= ':' ( (lv_read_9_0= 'T' ) ) )? (otherlv_10= 'Update' otherlv_11= ':' ( (lv_update_12_0= 'T' ) ) )? (otherlv_13= 'Delete' otherlv_14= ':' ( (lv_delete_15_0= 'T' ) ) )? (otherlv_16= 'All' otherlv_17= ':' ( (lv_all_18_0= 'T' ) ) )? ) )
            // InternalSCDsl.g:1110:2: (otherlv_0= 'AssetRel' otherlv_1= 'Participant' otherlv_2= ':' ( (lv_participant_3_0= RULE_ID ) ) (otherlv_4= 'Create' otherlv_5= ':' ( (lv_create_6_0= 'T' ) ) )? (otherlv_7= 'Read' otherlv_8= ':' ( (lv_read_9_0= 'T' ) ) )? (otherlv_10= 'Update' otherlv_11= ':' ( (lv_update_12_0= 'T' ) ) )? (otherlv_13= 'Delete' otherlv_14= ':' ( (lv_delete_15_0= 'T' ) ) )? (otherlv_16= 'All' otherlv_17= ':' ( (lv_all_18_0= 'T' ) ) )? )
            {
            // InternalSCDsl.g:1110:2: (otherlv_0= 'AssetRel' otherlv_1= 'Participant' otherlv_2= ':' ( (lv_participant_3_0= RULE_ID ) ) (otherlv_4= 'Create' otherlv_5= ':' ( (lv_create_6_0= 'T' ) ) )? (otherlv_7= 'Read' otherlv_8= ':' ( (lv_read_9_0= 'T' ) ) )? (otherlv_10= 'Update' otherlv_11= ':' ( (lv_update_12_0= 'T' ) ) )? (otherlv_13= 'Delete' otherlv_14= ':' ( (lv_delete_15_0= 'T' ) ) )? (otherlv_16= 'All' otherlv_17= ':' ( (lv_all_18_0= 'T' ) ) )? )
            // InternalSCDsl.g:1111:3: otherlv_0= 'AssetRel' otherlv_1= 'Participant' otherlv_2= ':' ( (lv_participant_3_0= RULE_ID ) ) (otherlv_4= 'Create' otherlv_5= ':' ( (lv_create_6_0= 'T' ) ) )? (otherlv_7= 'Read' otherlv_8= ':' ( (lv_read_9_0= 'T' ) ) )? (otherlv_10= 'Update' otherlv_11= ':' ( (lv_update_12_0= 'T' ) ) )? (otherlv_13= 'Delete' otherlv_14= ':' ( (lv_delete_15_0= 'T' ) ) )? (otherlv_16= 'All' otherlv_17= ':' ( (lv_all_18_0= 'T' ) ) )?
            {
            otherlv_0=(Token)match(input,37,FOLLOW_28); 

            			newLeafNode(otherlv_0, grammarAccess.getAssetRelAccess().getAssetRelKeyword_0());
            		
            otherlv_1=(Token)match(input,18,FOLLOW_3); 

            			newLeafNode(otherlv_1, grammarAccess.getAssetRelAccess().getParticipantKeyword_1());
            		
            otherlv_2=(Token)match(input,12,FOLLOW_4); 

            			newLeafNode(otherlv_2, grammarAccess.getAssetRelAccess().getColonKeyword_2());
            		
            // InternalSCDsl.g:1123:3: ( (lv_participant_3_0= RULE_ID ) )
            // InternalSCDsl.g:1124:4: (lv_participant_3_0= RULE_ID )
            {
            // InternalSCDsl.g:1124:4: (lv_participant_3_0= RULE_ID )
            // InternalSCDsl.g:1125:5: lv_participant_3_0= RULE_ID
            {
            lv_participant_3_0=(Token)match(input,RULE_ID,FOLLOW_29); 

            					newLeafNode(lv_participant_3_0, grammarAccess.getAssetRelAccess().getParticipantIDTerminalRuleCall_3_0());
            ...
            // InternalSCDsl.g:1141:3: (otherlv_4= 'Create' otherlv_5= ':' ( (lv_create_6_0= 'T' ) ) )?
            int alt14=2;
            ...
            switch (alt14) {
                case 1 :
                    // InternalSCDsl.g:1142:4: otherlv_4= 'Create' otherlv_5= ':' ( (lv_create_6_0= 'T' ) )
                    {
                    otherlv_4=(Token)match(input,38,FOLLOW_3); 

                    				newLeafNode(otherlv_4, grammarAccess.getAssetRelAccess().getCreateKeyword_4_0());
                    			
                    otherlv_5=(Token)match(input,12,FOLLOW_15); 

                    				newLeafNode(otherlv_5, grammarAccess.getAssetRelAccess().getColonKeyword_4_1());
                    			
                    // InternalSCDsl.g:1150:4: ( (lv_create_6_0= 'T' ) )
                    // InternalSCDsl.g:1151:5: (lv_create_6_0= 'T' )
                    {
                    // InternalSCDsl.g:1151:5: (lv_create_6_0= 'T' )
                    // InternalSCDsl.g:1152:6: lv_create_6_0= 'T'
                    {
                    lv_create_6_0=(Token)match(input,20,FOLLOW_30); 

                    						newLeafNode(lv_create_6_0, grammarAccess.getAssetRelAccess().getCreateTKeyword_4_2_0());
                    					

                    						if (current==null) {
                    							current = createModelElement(grammarAccess.getAssetRelRule());
                    						}
                    						setWithLastConsumed(current, "create", lv_create_6_0 != null, "T");
            ...
            // InternalSCDsl.g:1165:3: (otherlv_7= 'Read' otherlv_8= ':' ( (lv_read_9_0= 'T' ) ) )?
            int alt15=2;
            ...
            switch (alt15) {
                case 1 :
                    // InternalSCDsl.g:1166:4: otherlv_7= 'Read' otherlv_8= ':' ( (lv_read_9_0= 'T' ) )
                    {
                    otherlv_7=(Token)match(input,39,FOLLOW_3); 

                    				newLeafNode(otherlv_7, grammarAccess.getAssetRelAccess().getReadKeyword_5_0());
                    			
                    otherlv_8=(Token)match(input,12,FOLLOW_15); 

                    				newLeafNode(otherlv_8, grammarAccess.getAssetRelAccess().getColonKeyword_5_1());
                    			
                    // InternalSCDsl.g:1174:4: ( (lv_read_9_0= 'T' ) )
                    // InternalSCDsl.g:1175:5: (lv_read_9_0= 'T' )
                    {
                    // InternalSCDsl.g:1175:5: (lv_read_9_0= 'T' )
                    // InternalSCDsl.g:1176:6: lv_read_9_0= 'T'
                    {
                    lv_read_9_0=(Token)match(input,20,FOLLOW_31); 

                    						newLeafNode(lv_read_9_0, grammarAccess.getAssetRelAccess().getReadTKeyword_5_2_0());
                    					

                    						if (current==null) {
                    							current = createModelElement(grammarAccess.getAssetRelRule());
                    						}
                    						setWithLastConsumed(current, "read", lv_read_9_0 != null, "T");
            ...
            // InternalSCDsl.g:1189:3: (otherlv_10= 'Update' otherlv_11= ':' ( (lv_update_12_0= 'T' ) ) )?
            int alt16=2;
            ...
            switch (alt16) {
                case 1 :
                    // InternalSCDsl.g:1190:4: otherlv_10= 'Update' otherlv_11= ':' ( (lv_update_12_0= 'T' ) )
                    {
                    otherlv_10=(Token)match(input,40,FOLLOW_3); 

                    				newLeafNode(otherlv_10, grammarAccess.getAssetRelAccess().getUpdateKeyword_6_0());
                    			
                    otherlv_11=(Token)match(input,12,FOLLOW_15); 

                    				newLeafNode(otherlv_11, grammarAccess.getAssetRelAccess().getColonKeyword_6_1());
                    			
                    // InternalSCDsl.g:1198:4: ( (lv_update_12_0= 'T' ) )
                    // InternalSCDsl.g:1199:5: (lv_update_12_0= 'T' )
                    {
                    // InternalSCDsl.g:1199:5: (lv_update_12_0= 'T' )
                    // InternalSCDsl.g:1200:6: lv_update_12_0= 'T'
                    {
                    lv_update_12_0=(Token)match(input,20,FOLLOW_32); 

                    						newLeafNode(lv_update_12_0, grammarAccess.getAssetRelAccess().getUpdateTKeyword_6_2_0());
                    					

                    						if (current==null) {
                    							current = createModelElement(grammarAccess.getAssetRelRule());
                    						}
                    						setWithLastConsumed(current, "update", lv_update_12_0 != null, "T");
            ...
            // InternalSCDsl.g:1213:3: (otherlv_13= 'Delete' otherlv_14= ':' ( (lv_delete_15_0= 'T' ) ) )?
            int alt17=2;
            ...
            switch (alt17) {
                case 1 :
                    // InternalSCDsl.g:1214:4: otherlv_13= 'Delete' otherlv_14= ':' ( (lv_delete_15_0= 'T' ) )
                    {
                    otherlv_13=(Token)match(input,41,FOLLOW_3); 

                    				newLeafNode(otherlv_13, grammarAccess.getAssetRelAccess().getDeleteKeyword_7_0());
                    			
                    otherlv_14=(Token)match(input,12,FOLLOW_15); 

                    				newLeafNode(otherlv_14, grammarAccess.getAssetRelAccess().getColonKeyword_7_1());
                    			
                    // InternalSCDsl.g:1222:4: ( (lv_delete_15_0= 'T' ) )
                    // InternalSCDsl.g:1223:5: (lv_delete_15_0= 'T' )
                    {
                    // InternalSCDsl.g:1223:5: (lv_delete_15_0= 'T' )
                    // InternalSCDsl.g:1224:6: lv_delete_15_0= 'T'
                    {
                    lv_delete_15_0=(Token)match(input,20,FOLLOW_33); 

                    						newLeafNode(lv_delete_15_0, grammarAccess.getAssetRelAccess().getDeleteTKeyword_7_2_0());
                    					

                    						if (current==null) {
                    							current = createModelElement(grammarAccess.getAssetRelRule());
                    						}
                    						setWithLastConsumed(current, "delete", lv_delete_15_0 != null, "T");
            ...
            // InternalSCDsl.g:1237:3: (otherlv_16= 'All' otherlv_17= ':' ( (lv_all_18_0= 'T' ) ) )?
            int alt18=2;
            ...
            switch (alt18) {
                case 1 :
                    // InternalSCDsl.g:1238:4: otherlv_16= 'All' otherlv_17= ':' ( (lv_all_18_0= 'T' ) )
                    {
                    otherlv_16=(Token)match(input,42,FOLLOW_3); 

                    				newLeafNode(otherlv_16, grammarAccess.getAssetRelAccess().getAllKeyword_8_0());
                    			
                    otherlv_17=(Token)match(input,12,FOLLOW_15); 

                    				newLeafNode(otherlv_17, grammarAccess.getAssetRelAccess().getColonKeyword_8_1());
                    			
                    // InternalSCDsl.g:1246:4: ( (lv_all_18_0= 'T' ) )
                    // InternalSCDsl.g:1247:5: (lv_all_18_0= 'T' )
                    {
                    // InternalSCDsl.g:1247:5: (lv_all_18_0= 'T' )
                    // InternalSCDsl.g:1248:6: lv_all_18_0= 'T'
                    {
                    lv_all_18_0=(Token)match(input,20,FOLLOW_2); 

                    						newLeafNode(lv_all_18_0, grammarAccess.getAssetRelAccess().getAllTKeyword_8_2_0());
                    					

                    						if (current==null) {
                    							current = createModelElement(grammarAccess.getAssetRelRule());
                    						}
                    						setWithLastConsumed(current, "all", lv_all_18_0 != null, "T");
    ...
    // InternalSCDsl.g:1265:1: ruleTargetPlatform returns [Enumerator current=null] : ( (enumLiteral_0= 'IBM' ) | (enumLiteral_1= 'Azure' ) | (enumLiteral_2= 'Solidity' ) ) ;
    public final Enumerator ruleTargetPlatform() throws RecognitionException {
        ...
        try {
            // InternalSCDsl.g:1271:2: ( ( (enumLiteral_0= 'IBM' ) | (enumLiteral_1= 'Azure' ) | (enumLiteral_2= 'Solidity' ) ) )
            // InternalSCDsl.g:1272:2: ( (enumLiteral_0= 'IBM' ) | (enumLiteral_1= 'Azure' ) | (enumLiteral_2= 'Solidity' ) )
            {
            // InternalSCDsl.g:1272:2: ( (enumLiteral_0= 'IBM' ) | (enumLiteral_1= 'Azure' ) | (enumLiteral_2= 'Solidity' ) )
            int alt19=3;
            switch ( input.LA(1) ) {
            ...
            switch (alt19) {
                case 1 :
                    // InternalSCDsl.g:1273:3: (enumLiteral_0= 'IBM' )
                    {
                    // InternalSCDsl.g:1273:3: (enumLiteral_0= 'IBM' )
                    // InternalSCDsl.g:1274:4: enumLiteral_0= 'IBM'
                    {
                    ...
                    break;
                case 2 :
                    // InternalSCDsl.g:1281:3: (enumLiteral_1= 'Azure' )
                    {
                    // InternalSCDsl.g:1281:3: (enumLiteral_1= 'Azure' )
                    // InternalSCDsl.g:1282:4: enumLiteral_1= 'Azure'
                    {
                    ...
                    break;
                case 3 :
                    // InternalSCDsl.g:1289:3: (enumLiteral_2= 'Solidity' )
                    {
                    // InternalSCDsl.g:1289:3: (enumLiteral_2= 'Solidity' )
                    // InternalSCDsl.g:1290:4: enumLiteral_2= 'Solidity'
                    {
    ...
    public static final BitSet FOLLOW_6 = new BitSet(new long[]{0x0000380000000000L});
    public static final BitSet FOLLOW_7 = new BitSet(new long[]{0x0000000002240002L});
    public static final BitSet FOLLOW_8 = new BitSet(new long[]{0x0000000000004000L});
    public static final BitSet FOLLOW_9 = new BitSet(new long[]{0x0000000000008000L});
    public static final BitSet FOLLOW_10 = new BitSet(new long[]{0x0000000000010000L});
    public static final BitSet FOLLOW_11 = new BitSet(new long[]{0x0000000040828000L});
    ...
    public static final BitSet FOLLOW_20 = new BitSet(new long[]{0x0000000030020000L});
    ...
    public static final BitSet FOLLOW_30 = new BitSet(new long[]{0x0000078000000002L});
    public static final BitSet FOLLOW_31 = new BitSet(new long[]{0x0000070000000002L});
